...
import sys
print(f"NOTYET, To be sorted out")
sys.exit()
...
icmInfo['moduleName'] = "icmEx-clsMethod"
####+END:

####+BEGIN: bx:icm:py:version-timestamp :style "date"
icmInfo['version'] = "202110072142"
####+END:
...
"""
*  This file:/bisos/git/auth/bxRepos/bisos-pip/icm/py3/bisos/icm/icmEx-clsMethod.py :: [[elisp:(org-cycle)][| ]]
...
####+END:
    ...
    clsMethod.commonParamsSpecify(icmParams,)
...
####+END:
        ...
        clsMethod.examples_clsMethod('ExampleClass', 'argsEcho')
...
####+BEGIN: bx:dblock:python:class :className "ExampleClass" :superClass "object" :comment "Expected to be subclassed" :classType "basic"
"""
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  Class-basic :: /ExampleClass/ object =Expected to be subclassed=  [[elisp:(org-cycle)][| ]]
"""
...
"""
    ...
    def argsEcho(
        ...
        """For development use."""
        for eachArg in args:
            print(f"Args: {eachArg}")
        for eachKwArg in kwArgs:
            print(f"KWArgs: {eachKwArg}")
